...
async def cbstart(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""👋🏻 **اهلا ياحلو[{query.message.chat.first_name}](tg://user?id={query.message.chat.id}) !**\n
🎗 **[{VFF35}](https://t.me/{BOT_USERNAME}) انا زوزو يمكنني تشغيل اغاني وفيديوهات في المكالمة الصوتية!**

★ **لتعرف اوامري ياحلو اضغط على » الاوامر الاساسية!**

★ **لتعرف شلون تشغيلي بقروبك اضغط على » طريقة التشغيل!**""",
...
» .زوزو ادخلي - دعوة حساب المساعد للمجموعة
» .زوزو اطلعي - لخروج حساب مساعد من لمجموعة
